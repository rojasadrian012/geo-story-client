...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, OnChanges, SimpleChanges, input, output, signal } from '@angular/core';
...
export class SelectedAnswerComponent {
    ...
    selectedOption(response: Answer) {
        console.log(this.isDisable()); //cada click imprime false
